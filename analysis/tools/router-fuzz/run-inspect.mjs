...
await page.goto(`http://localhost:${port}/router-fuzz/inspect.html`,{waitUntil:'load'});
await page.waitForFunction('window.__I__!==undefined',{timeout:600000}).catch(()=>{});
const r=await page.evaluate(()=>window.__I__??null);

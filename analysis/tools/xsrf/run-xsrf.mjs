...
await page.goto(`http://localhost:${port}/router-fuzz/xsrf.html`,{waitUntil:'load'});
await page.waitForFunction('window.__XSRF__!==undefined',{timeout:25000}).catch(()=>{});
const r=await page.evaluate(()=>window.__XSRF__??null);
